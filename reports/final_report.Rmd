...
histogram <- readPNG(("Stats-170-Cap-Stone/data/images/145948_plots/hist.png"))
likelihood <- readPNG(("Stats-170-Cap-Stone/data/images/145948_plots/plot-likelihood.png"))
xyplot <- readPNG(("Stats-170-Cap-Stone/data/images/145948_plots/trajectory.png"))
xytime <- readPNG(("Stats-170-Cap-Stone/data/images/145948_plots/plot.png"))

grid.arrange(rasterGrob(histogram),rasterGrob(likelihood),rasterGrob(xyplot),rasterGrob(xytime),ncol=2)

```

We were then able to use DeepLabCut to create plots to analyze the accuracy of the trained neural network on the videos we created. From this it outputted CSV files and plots which showed the x versus y coordinates of the skeletal structure, skeletal structure coordinates each frame, likelihood of each body part in the skeletal structure per frame, and the count of delta x and delta y by body part. 
