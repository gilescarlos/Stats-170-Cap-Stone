...
```{r echo = FALSE}
options(digits = 3)
colnames(post_injury) <- c("Animal ID", "Total Good Steps", "Total Bad Steps", "Avg Good Steps", "Avg Bad Steps", "LB Score", "Type")
...
```{r echo = FALSE}
colnames(dlc_train) <- c("Video", "Frame", "Bodypart", "X", "Y")
